...
def index():
    ...
    if form.validate_on_submit():
        ...
        db.session.add(post)
        db.session.commit()
    page = request.args.get('page', 1, type=int)    # request.args pour acceder aux arguments dans une query string (après le ? dans l'adresse de la page)
...
def edit_profile():
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        flash('Your chages have been saved')
